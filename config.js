...
const settingsMenu = [
    ...
    {title: "true", env_var: "AUTO_READ_STATUS"},
...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~ef3c41cebb51ec4f522e5cd646d7d7fd:4b457664366d414d6454633d")
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://graph.org/file/b373b90acd94cb2908739.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    ANTIWORD_WARN: process.env.ANTIWORD_WARN || '5',
    ...
    READ_MESSAGES: (process.env.READ_MESSAGES) || true,
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~ef3c41cebb51ec4f522e5cd646d7d7fd:4b457664366d414d6454633d',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '',
    BOT_INFO: process.env.BOT_INFO || 'Wally Jay Tech',
    RBG_KEY: process.env.RBG_KEY || 'dyrbNSNtMf1CE84he61DR7Wx',
    ALLOWED: process.env.ALLOWED || '234',
    NOT_ALLOWED: process.env.ALLOWED || '',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.',
    STICKER_DATA: process.env.STICKER_DATA || "WALLYJAYTECH-MD",
    BOT_NAME: process.env.BOT_NAME || 'WALLYJAYTECH-MD',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'WALLYJAYTECH-MD;WALLYJAYTECH MD bot;https://graph.org/file/b373b90acd94cb2908739.jpg' : process.env.AUDIO_DATA,
